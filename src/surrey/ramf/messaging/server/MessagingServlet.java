...
import surrey.ramf.exception.InitializeException;
...
public class MessagingServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		try {
			...
			String initializerClassName = getServletConfig().getInitParameter(
					INITIALIZER_NAME);
			...
			LogWriter.error(getClass(),
					"Failed to initialize RAMFServer: " + e, e);
		}
	}
	...
	protected void service(HttpServletRequest request,
		...
		Endpoint endpoint = server.getEndpoint(applicationContext,
				endpointContext, endpointInfo);
